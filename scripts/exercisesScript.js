    ...
    listItems.addEventListener("click", () => {
      switch (element) {
        case (element = "Past tense"):
          window.location.href = "/pages/verbs.html";
    ...
    listItems.addEventListener("click", () => {
      ...
      switch (element) {
        case (element = "A Day at the Zoo"):
          window.location.href = "/pages/readText/A1/a_day_at_the_zoo.html";
          break;
        case (element = "A Trip to the Beach"):
          window.location.href = "/pages/readText/A1/a_trip_to_the_beach.html";
          break;
        case (element = "My Daily Routine"):
          window.location.href = "/pages/readText/A1/my_daily_routine.html";
          break;
        case (element = "My Family"):
          window.location.href = "/pages/readText/A1/my_Family.html";
          break;
        case (element = "My Favorite Hobby"):
          window.location.href = "/pages/readText/A1/my_favorite_hobby.html";
          break;
        case (element = "My Pet Cat"):
          window.location.href = "/pages/readText/A1/my_pet_cat.html";
          break;
        case (element = "My Pet"):
          window.location.href = "/pages/readText/A1/my_Pet.html";
          break;
        case (element = "My School"):
          window.location.href = "/pages/readText/A1/my_school.html";
          break;
        case (element = "A Day in the City"):
          window.location.href = "/pages/readText/A2/a_day_in_the_city.html";
          break;
        case (element = "My Best Friend"):
          window.location.href = "/pages/readText/A2/my_best_friend.html";
          break;
        case (element = "A Visit to the Library"):
          window.location.href = "/pages/readText/A2/visit_to_the_library.html";
          break;
        case (element = "A Weekend Trip to the Mountains"):
          window.location.href =
            "/pages/readText/A2/week_trip_in_mountains.html";
          break;
        case (element = "Going Abroad"):
          window.location.href = "/pages/readText/B1/going_abroad.html";
          break;
        case (element = "Job Searching"):
          window.location.href = "/pages/readText/B1/job_searching.html";
          break;
        case (element = "Visiting the Doctor"):
          window.location.href = "/pages/readText/B1/visiting_the_doctor.html";
          break;
        case (element = "A Walk in the Forest"):
          window.location.href = "/pages/readText/B1/walk_in_the_forest.html";
          break;
        case (element = "A Typical Day at the Office"):
          window.location.href =
            "/pages/readText/B2/a_typical_day_at_the_office.html";
          break;
        case (element = "A Comprehensive Guide to Buying a Car"):
          window.location.href =
            "/pages/readText/B2/comprehensive_guide_to_buying_a_car.html";
          break;
        case (element = "How to Prepare for a Doctor's Appointment"):
          window.location.href = "/pages/readText/B2/doctors_Appointment.html";
          break;
        case (element = "Effective Strategies for Client Meetings"):
          window.location.href =
            "/pages/readText/B2/how_to_conduct_a_successful_client_meeting.html";
          break;
        case (element = "Mastering Office Culture and Dynamics"):
          window.location.href =
            "/pages/readText/C1/mastering_office_culture_and_dynamics.html";
          break;
        case (element = "How to Conduct a Successful Client Meeting"):
          window.location.href =
            "/pages/readText/C1/effective_strategies_for_client_meetings.html";
          break;
        case (element = "Preparing for a Comprehensive Medical Examination"):
          window.location.href =
            "/pages/readText/C1/preparing_for_a_comprehensive_medical_examination.html";
          break;
        case (element = "The Process of Purchasing a New Vehicle"):
          window.location.href =
            "/pages/readText/C1/the_process_of_purchasing_a_new_vehicle.html";
          break;
      }
    });
  });
